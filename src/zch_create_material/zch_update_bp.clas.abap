CLASS zch_update_bp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCH_UPDATE_BP IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    update_addcell = VALUE #(
          ...
          CompleteTelephoneNumber = '22009909'
          MobilePhoneNumber = '09123456766'
...
*          %is_draft = if_abap_behv=>mk-on
    ...
    update_email = VALUE #(
            ...
            %key-OrdinalNumber = '001'
            %key-Person = '0000040789'
            EmailAddress = 'chase123@gmail.com'
