...
define view entity zch_soitem    as select from ZTDI_VBAP
...
//                                                      and $projection.SalesDocumentItem = _ZTDC_VBEP.SalesDocumentItem
  ...
  association [1..*] to zch_dn as _zch_dn on  $projection.SalesDocument     = _zch_dn.ReferenceSDDocument
                                                      and $projection.SalesDocumentItem = _zch_dn.ReferenceSDDocumentItem
