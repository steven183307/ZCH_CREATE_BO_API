CLASS zch_update_material1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCH_UPDATE_MATERIAL1 IMPLEMENTATION.
...
* MinRemainingShelfLife = 2
    ...
    update_sales = VALUE #(
     ...
     SalesStatus = '01'
     SalesStatusValidityDate = '20231006'
    ...
    update_plant = VALUE #(
        ...
        %key-Plant = '6310'
        ProfitCenter = 'YB102'
*        StockDeterminationGroup = '0001'
*        ProfileValidityStartDate = '20231006'


        %control-ProfitCenter = cl_abap_behv=>flag_changed
*        %control-StockDeterminationGroup = cl_abap_behv=>flag_changed
*        %control-ProfileValidityStartDate = cl_abap_behv=>flag_changed
        ).

    APPEND update_plant TO update_plant2.

*    create_PlantMRP = VALUE #(
*      %key-Product = 'MATERIAL9519'
*      %key-Plant = '6310'
*      %target = VALUE #( (
*                        Product = 'MATERIAL9519'
...
*      ).
*
*      APPEND create_plantmrp to create_plantmrp2.
...
*            SalesMeasureUnit = 'CMS'
            ...
            ProductSalesStatusValidityDate = '20231011'
...
*     UPDATE FROM update_varea2
    ...
    IF Failed IS NOT INITIAL.
      ...
      ENDLOOP.
      LOOP AT reported-productplantmrp ASSIGNING FIELD-SYMBOL(<lt_proudct4>).
    ...
    ELSE.
      ...
      IF failed_commit IS NOT INITIAL.
        ...
        ENDLOOP.
        LOOP AT reported_commit-productplantmrp ASSIGNING FIELD-SYMBOL(<lt_proudct3>).
